...
// WEBRTC TODO: Replace Record<string, never> with TextEntityProperties.
...
class TextEntityItem {
    ...
    static readEntitySubclassDataFromBuffer(data: DataView, position: number, propertyFlags: PropertyFlags): TextEntitySubclassData { // eslint-disable-line class-methods-use-this
...
export type { TextEntitySubclassData };
